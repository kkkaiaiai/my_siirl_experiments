...
export EXPERIMENT_CORE_NAME=gae_train_bsz${TRAIN_BATCH_SIZE}_mini_bsz${PPO_MINI_BATCH_SIZE}_rollout_n${ROLLOUT_N}_clip_eps_high${CLIP_RATIO_HIGH}_lr_warmup_style${LR_WARMUP_STYLE}_total_epoch${TOTAL_EPOCHS}
...
export PROJECT_NAME=siirl_gae_${DATASET}_${ALG}
export EXPERIMENT_NAME=siirl_gae_${MODEL_NAME}_${ALG}_${DATASET}_experiment_${EXPERIMENT_CORE_NAME}
