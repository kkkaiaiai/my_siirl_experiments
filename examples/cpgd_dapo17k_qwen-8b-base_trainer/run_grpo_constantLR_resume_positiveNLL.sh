...
export positive_sft_coeff=0.1

# --- Key difference in the experiments ---
export EXPERIMENT_CORE_NAME=train_bsz${TRAIN_BATCH_SIZE}_mini_bsz${PPO_MINI_BATCH_SIZE}_rollout_n${ROLLOUT_N}_clip_eps_high${CLIP_RATIO_HIGH}_lr_warmup_style${LR_WARMUP_STYLE}_total_epoch${TOTAL_EPOCHS}_positiveNLL${positive_sft_coeff}
...
TRAINING_CMD=(
    python3 -m siirl.client.main_dag
        ...
        actor_rollout_ref.actor.positive_sft_coeff=$positive_sft_coeff
