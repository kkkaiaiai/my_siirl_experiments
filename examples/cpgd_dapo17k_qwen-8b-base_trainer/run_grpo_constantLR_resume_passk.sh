...
export EXPERIMENT_CORE_NAME=passk_klCov01coef_train_bsz${TRAIN_BATCH_SIZE}_mini_bsz${PPO_MINI_BATCH_SIZE}_rollout_n${ROLLOUT_N}_clip_eps_high${CLIP_RATIO_HIGH}_lr_warmup_style${LR_WARMUP_STYLE}_total_epoch${TOTAL_EPOCHS}
...
TRAINING_CMD=(
    python3 -m siirl.client.main_dag
        ...
        actor_rollout_ref.actor.policy_drift_coeff=0.1
