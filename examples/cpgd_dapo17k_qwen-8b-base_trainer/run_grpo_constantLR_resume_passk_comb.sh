...
export REWARD_FN_PATH=$HOME/examples/cpgd_dapo17k_qwen-8b-base_trainer/reward_func.py
...
export MAX_CKPT_KEEP=100
export CLIP_RATIO_HIGH=0.2
export LR_WARMUP_STYLE='constant'  # cosine, constant
export POLICY_DRIFT_COEFF=0.01

# --- Key difference in the experiments ---
export EXPERIMENT_CORE_NAME=passk_klCov_train_bsz${TRAIN_BATCH_SIZE}_mini_bsz${PPO_MINI_BATCH_SIZE}_rollout_n${ROLLOUT_N}_clip_eps_high${CLIP_RATIO_HIGH}_drift_coeff${POLICY_DRIFT_COEFF}_lr_warmup_style${LR_WARMUP_STYLE}_total_epoch${TOTAL_EPOCHS}
...
export CKPT_PATH=${BASE_CKPT_PATH}/${MODEL_NAME}_${ALG}_${DATASET}_hybrid/nodes${NNODES}_${EXPERIMENT_CORE_NAME}
export PROJECT_NAME=siirl_${DATASET}_${ALG}
export EXPERIMENT_NAME=siirl_${MODEL_NAME}_${ALG}_${DATASET}_experiment_${EXPERIMENT_CORE_NAME}
export TENSORBOARD_DIR=${BASE_TENSORBOARD_PATH}/${MODEL_NAME}_${DATASET}_test${TEST_DATASET}/time${timestamp}_nodes${NNODES}_algo${ALG}_${EXPERIMENT_CORE_NAME}
export SIIRL_LOGGING_FILENAME=${MODEL_NAME}_${ALG}_${DATASET}_time${timestamp}_nodes${NNODES}_${EXPERIMENT_CORE_NAME}
...
TRAINING_CMD=(
    python3 -m siirl.client.main_dag
        ...
        actor_rollout_ref.actor.policy_drift_coeff=\$POLICY_DRIFT_COEFF
