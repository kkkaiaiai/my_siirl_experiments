...
def get_chat_response(prompt, model="gpt-4o", max_token=256, retry=5, temperature=None):
    ...
    for i in range(retry):
        ...
        try:
            ...
            #     model=model,    # use model in list [gpt-4o, gpt-4o-mini, o1, o3-mini, o3, o4-mini, gpt-4.1, gpt-4.1-mini, gpt-4.1-nano]
            #     messages=messages, temperature=temperature, max_tokens=max_token
            #     )
