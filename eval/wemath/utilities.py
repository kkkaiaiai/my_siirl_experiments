...
# API_KEY="aa248a711f6c486691ae884194348b70"
...
def get_chat_response(promot, api_key, model='gpt-4o', temperature=0, max_tokens=256, n=1, patience=10000000,
                      sleep_time=0):
    messages = [
...
def get_chat_response_vlmevalkit(prompt, model='gpt-4o', max_token=256, retry=5):
    messages = [
