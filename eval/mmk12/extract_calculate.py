    ...
    for i in range(retry):
        try:
            ...
            completion = client.chat.completions.create(    
                model="gpt-4.1-nano",    # use model in list [gpt-4o, gpt-4o-mini, o1, o3-mini, o3, o4-mini, gpt-4.1, gpt-4.1-mini, gpt-4.1-nano]
                messages=messages, temperature=0.5 * i, max_tokens=max_token
                )
